...
function App() {
  ...
  return (
    <div className='flex flex-col items-center justify-center mx-auto min-h-screen bg-slate-700'>
      <div className='rounded mt-2 w-4/5 px-1 py-2 bg-slate-800 shadow-md shadow-gray-900'>
        <NavBar menuToggle={menuToggle} setMenuToggle={setMenuToggle} />
      </div>
      <div className='rounded mt-1 mb-2 w-4/5 px-1 py-2 bg-slate-800 shadow-md shadow-gray-900'>
